              ...
              <div className="criterio-text-box">
                ...
                <div className="popup">
                  <div className="popup-contenido">
                    ...
                    <h1>Congruencia Entre Metas y Objetivos</h1>
                    <p> Se valora el nivel de equilibrio, claridad y realismo del candidato en los dos últimos puntos valorados en la entrevista.</p>
